...
public class ChatToServer extends javax.swing.JDialog {
    private Socket socketConnectServer;
    private Packet pkChat;

    public ChatToServer(Socket socketConnectServer) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Utils.sendMess(socketConnectServer, pkChat.toString());
